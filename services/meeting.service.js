...
class MeetingService {
  ...
  async searchMeetings(queryParams, userContext) {
    try {
      return await meetingRepository.findByQuery(queryParams);
    } catch (error) {
  ...
  async updateMeeting(id, updates, userContext) {
    try {
      return await meetingRepository.updateById(id, updates);
    } catch (error) {
  ...
  async deleteMeeting(id, userContext) {
    try {
      return await meetingRepository.deleteById(id);
    } catch (error) {
